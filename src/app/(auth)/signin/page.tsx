...
function Signin() {
  ...
  return (
    <div className="bg-pink-700 min-h-screen flex justify-center items-center">
      <div className="w-96 max-sm:w-80 h-[450px] text-shadow shadow-2xl backdrop-blur-lg rounded-lg mx-auto bg-white p-4 pt-12 flex flex-col">
        <h1 className="text-center text-2xl  text-pink-700">Welcome Back</h1>
        <h4 className="font-thin text-[14px] text-center py-2">
          Start Expressing Your Ideas
        </h4>
        <button onClick={signInWithGoogle} className="btn max-sm:w-60 max-sm:mx-6 text-black bg-white text-sm rounded-sm w-80 mx-3 mt-4">
          <Image
          alt=""
          src={'/google.png'}
          height={30}
        ...
        <span className="text-center font-thin text-[12px] pt-3">---------- Or with email and password ------------</span>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <p className="text-sm max-sm:mx-7 font-bold mx-3 mt-2 ">
          ...
          <button
            type="submit"
            className="btn max-sm:w-60 max-sm:mx-6 mt-4 bg-pink-600  rounded-sm w-80 mx-3"
          >
            Login
          </button>
        </form>
